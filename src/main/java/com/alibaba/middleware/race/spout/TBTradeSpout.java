...
public class TBTradeSpout implements IRichSpout {


	private static Logger LOG = LoggerFactory.getLogger(TBTradeSpout.class);
    ...
    private void initConsumer() throws MQClientException{
    	consumer = new DefaultMQPushConsumer("TBTradeConsumer");
	...
	public void nextTuple() {
		...
		try {
			...
			LOG.info("TBTradeSpout Emit:" + orderMessage.toString());
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
