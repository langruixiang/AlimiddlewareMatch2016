...
//    public static final String HOME_PATH = "Z:/AliProject/AliMiddlewareSolution/tmpfile/";
    ...
    public static int SPOUT_MAX_SEND_NUMBER_PER_NEXT_TUPLE = 20000;
    ...
    public static long PAY_MSG_PART_SUM_SEND_INTERVAL = 20000L;
    public static long PLATFORM_DISTINGUISH_SEND_INTERVAL = 10000L;
    public static long RATIO_WRITE_TAIR_INTERVAL = 20000L;
    public static long TM_OR_TB_COUNTER_WRITE_TAIR_INTERVAL = 5000L;

    public static int sumCounterMapInitCapacity = 100000;
